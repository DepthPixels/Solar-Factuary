...
export const createScene = (canvas) => {
  ...
  planetMaterial.emissiveTexture = new BABYLON.Texture('./textures/2k_mars.jpg', scene);
  ...
  let setupBasicUI = () => {
    ...
    let subTitleBox = new GUI.TextBlock('SubTitleBox', 'Mars');
  ...
  let setupFactsUI = () => {
    ...
    let fact1 = new GUI.TextBlock('Fact1', "1. Mars' largest and most enigmatic moon, Phobos, will eventually be torn apart by gravitational forces. This will lead to the formation of a debris field that will, eventually, settle down into a stable orbit and form a rocky ring around Mars.");
    ...
    let fact2 = new GUI.TextBlock('Fact2', "2. Scientists believe they have found proof that little bits of Mars have actually landed on Earth in the past. Called 'Martian Meteorites', these are little pieces of rock that have miraculously managed to make it to Earth.");
    ...
    let fact3 = new GUI.TextBlock('Fact3', "3. Mars also has the largest volcanoes in the solar system, Olympus Mons being one of them. The massive volcano, which is about 370 miles (600 km) in diameter, is wide enough to cover the state of New Mexico.");

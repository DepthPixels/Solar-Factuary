...
export const createScene = (canvas) => {
  ...
  planetMaterial.emissiveTexture = new BABYLON.Texture('./textures/2k_jupiter.jpg', scene);
  ...
  let setupBasicUI = () => {
    ...
    let subTitleBox = new GUI.TextBlock('SubTitleBox', 'Jupiter');
  ...
  let setupFactsUI = () => {
    ...
    let fact1 = new GUI.TextBlock('Fact1', "1. Lightning storms on the planets turn methane into soot which hardens into chunks of graphite and then diamonds as it falls making diamond rain.");
    ...
    let fact2 = new GUI.TextBlock('Fact2', "2. Like that of Earth, Jupiter seems to be having its aurora. In recent times, Hubbletelescope has discovered an electrifying blue aurora on the north pole of the Jupiter.");
    ...
    let fact3 = new GUI.TextBlock('Fact3', "3. The Great Red Spot was first observed by scientist Robert Hooke more than 350 years ago using a telescope. It is larger than the earth; however, recent observations have shown that this giant hurricane is shrinking and is currently at the smallest size it has ever been observed.");

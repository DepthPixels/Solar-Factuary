...
export const createScene = (canvas) => {
  ...
  planetMaterial.emissiveTexture = new BABYLON.Texture('./textures/2k_saturn.jpg', scene);
  ...
  let setupBasicUI = () => {
    ...
    let subTitleBox = new GUI.TextBlock('SubTitleBox', 'Saturn');
  ...
  let setupFactsUI = () => {
    ...
    let fact1 = new GUI.TextBlock('Fact1', "1. Saturn is ever losing its rings. As the rocks and ice of the rings move around Saturn, they are slowly losing pieces into Saturn as gravity pulls them in.");
    ...
    let fact2 = new GUI.TextBlock('Fact2', "2. Saturn orbits the Sun once every 29.4 Earth years. Therefore it was nicknamed 'Lubadsagush' meaning 'oldest of the old'.");
    ...
    let fact3 = new GUI.TextBlock('Fact3', "3. The Hexadiagonal-shaped pattern of clouds around Saturn's north pole may be a wave pattern in the upper clouds. There is also a vortex over the south pole which resembles hurricane storms on Earth.");

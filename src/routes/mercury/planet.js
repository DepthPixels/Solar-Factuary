...
export const createScene = (canvas) => {
  ...
  let setupBasicUI = () => {
    ...
    let subTitleBox = new GUI.TextBlock('SubTitleBox', 'Mercury');
  ...
  let setupFactsUI = () => {
    ...
    let fact1 = new GUI.TextBlock('Fact1', "1. When Mercury's magnetic field interacts with the solar wind, it sometimes generates magnetic tornadoes");
    ...
    let fact2 = new GUI.TextBlock('Fact2', "2. As the iron core of the planet cooled and contracted, the surface of the planet became wrinkled. Scientist have named these wrinkles, Lobate Scarps.");
    ...
    let fact3 = new GUI.TextBlock('Fact3', "3. Despite temperatures on its surface rising up to 450°C (840°F), there seems to be water ice on Mercury.");
